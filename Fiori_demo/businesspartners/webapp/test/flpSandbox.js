		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "suppilers",
									"targetURL": "#nsbusinesspartners-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsbusinesspartners-display": {
								"semanticObject": "nsbusinesspartners",
								"action": "display",
								"description": "An SAP Fiori application that shows a list of suppliers",
								"title": "suppilers",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.businesspartners",
									"url": sap.ui.require.toUrl("ns/businesspartners")
								}
							}
						}
					}
